(() => {
  ...
  const copy = {
    ...
    sv: {
      ...
      founder:'Om SundAI', founderTitle:'Oberoende, tvärdisciplinärt AI-initiativ', founderRole:'AI-styrning · säkerhet · människocentrerad teknik', founderText:'SundAI skapades för att förena AI-styrning, cybersäkerhet, organisatorisk risk och människocentrerad implementering i ett praktiskt europeiskt ramverk.', founderLink:'Om SundAI →', founderJobTitle:'Grundare',
